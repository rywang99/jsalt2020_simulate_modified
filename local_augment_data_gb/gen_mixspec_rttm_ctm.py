...
ctm_file = ["/train33/sppro/permanent/gbyang/data/LibriSpeech/librispeech_ctm/train_clean_100.ctm", 
            "/train33/sppro/permanent/gbyang/data/LibriSpeech/librispeech_ctm/train_clean_360.ctm",
            "/train33/sppro/permanent/gbyang/data/LibriSpeech/librispeech_ctm/dev_clean.ctm",
            "/train33/sppro/permanent/gbyang/data/LibriSpeech/librispeech_ctm/test_clean.ctm",
            "/train33/sppro/permanent/gbyang/data/LibriSpeech/librispeech_ctm/train_other_500.ctm",
            "/train33/sppro/permanent/gbyang/data/LibriSpeech/librispeech_ctm/dev_other.ctm",
            "/train33/sppro/permanent/gbyang/data/LibriSpeech/librispeech_ctm/test_other.ctm"
            ]
# ctm_file = ["/train33/sppro/permanent/gbyang/data/LibriSpeech/librispeech_ctm/dev_other.ctm",
#             "/train33/sppro/permanent/gbyang/data/LibriSpeech/librispeech_ctm/dev_clean.ctm"
#             ]
utt2label = {}
    ...
    with open(ctm) as IN:
        for l in IN:
            ...
            if utt not in utt2label.keys():
                utt2label[utt] = np.zeros(36 * 1000)
...
#/train33/sppro/permanent/gbyang/code/jsalt2020_simulate/simulate_data/data/MTG_t1_t2/mixspec.json
mixspec = sys.argv[1]
