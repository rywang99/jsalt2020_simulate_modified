...
if [ ! -v roomcfg ]; then
    ...
    roomcfg=$ROOTDIR/configs/common/meeting_reverb_mixer6.json
fi
if [ ! -v dyncfg ]; then
    dyncfg=$ROOTDIR/configs/common/meeting_dynamics_mixer6.json
fi
...
# datajson=simulate_data/librispeech_dev/dev.json
