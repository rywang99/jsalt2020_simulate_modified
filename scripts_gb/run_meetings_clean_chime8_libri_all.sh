...
if [ ! -v roomcfg ]; then
    ...
    roomcfg=$ROOTDIR/configs/common/meeting_clean.json
fi
if [ ! -v dyncfg ]; then
...
datajson=/train33/sppro/permanent/gbyang/code/jsalt2020_simulate/simulate_data/librispeech_all/all.json
