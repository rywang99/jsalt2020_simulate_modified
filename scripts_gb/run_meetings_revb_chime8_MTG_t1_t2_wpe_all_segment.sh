...
if [ ! -v roomcfg ]; then
    ...
    roomcfg=$ROOTDIR/configs/common/meeting_clean_circular7_chime8.json
fi
if [ ! -v dyncfg ]; then
    dyncfg=$ROOTDIR/configs/common/meeting_dynamics_chime8_8spk2_all_seg_MTG.json
fi
echo $roomcfg $dyncfg
...
datajson=/train33/sppro/permanent/gbyang/code/jsalt2020_simulate/simulate_data/MTG_t1_t2_wpe_train_all_segment/all.json
