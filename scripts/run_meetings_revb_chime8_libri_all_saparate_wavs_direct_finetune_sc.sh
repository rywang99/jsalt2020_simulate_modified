...
if [ ! -v roomcfg ]; then
    ...
    roomcfg=$ROOTDIR/configs/common/meeting_reverb_mono_chime8.json
fi
if [ ! -v dyncfg ]; then
...
python $mixspec --inputfile $datajson --outputfile $specjson --targetdir $tgtdir --random_seed 50 --config $dyncfg --repeate_times 75
