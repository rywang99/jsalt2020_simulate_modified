...
mixspec=$ROOTDIR/tools/gen_mixspec_mtg_gb.py
...
if [ ! -v dyncfg ]; then
    dyncfg=$ROOTDIR/configs/common/meeting_dynamics_chime8_8spk2_gb.json
fi
echo $roomcfg $dyncfg
...
#/train33/sppro/permanent/gbyang/code/jsalt2020_simulate/simulate_data/MTG_t1_t2_wpe_train/all.json
# datajson=/train33/sppro/permanent/gbyang/code/jsalt2020_simulate/simulate_data/MTG_t1_t2_wpe_train/all.json
# Generate mixture specs. 
# datajson=/train33/sppro/permanent/gbyang/code/jsalt2020_simulate/simulate_data/close_talk_reb_extend5_new/all.json
tgtdir=$tgtroot/wav
mkdir -p $tgtdir
